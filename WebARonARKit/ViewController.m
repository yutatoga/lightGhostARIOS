...
#define NOTCH_HEIGHT 0
#define NOTCH_WIDTH 209

#define URL_SAFE_AREA_VERTICAL 0
#define URL_SAFE_AREA_HORIZONTAL 0

#define URL_BUTTON_PADDING 0

#define URL_BUTTON_WIDTH_PORTRAIT_X 0
#define URL_BUTTON_HEIGHT_PORTRAIT_X 0

#define URL_BUTTON_WIDTH_PORTRAIT 0
#define URL_BUTTON_HEIGHT_PORTRAIT 0

#define URL_BUTTON_WIDTH_LANDSCAPE 0
#define URL_BUTTON_HEIGHT_LANDSCAPE 0

#define URL_TEXTFIELD_HEIGHT_EXPANDED 0
#define URL_TEXTFIELD_HEIGHT_MINIFIED 0

#define URL_TEXTFIELD_HEIGHT 0
#define PROGRESSVIEW_HEIGHT 0
...
- (void)viewDidLoad {
    ...
    int mtkViewOffset = NOTCH_HEIGHT + URL_SAFE_AREA_VERTICAL * 2 + URL_TEXTFIELD_HEIGHT_MINIFIED;
    [mtkView setFrame:CGRectMake(0, mtkViewOffset, self.view.frame.size.width, self.view.frame.size.height - mtkViewOffset)];
...
//    [self initNavigation];
    ...
    NSString *defaultSite =
        @"https://lightghostar.firebaseapp.com/";
